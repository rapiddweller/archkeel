...
| class_a | symbol_placement:test-helper-outside-support | test-scope-helper-in-unit | validate/report --config archkeel-tests.toml run | TESTS-HELPERS-IN-SUPPORT, TESTS-REQUIRES-COMPLETE | graph.drift, rule.violated, rule.violated | tests/integration/test_place_order.py, tests/support/orders.py, tests/unit/orders.py, tests/unit/test_entities.py |
| class_a | root_layout:test-helper-at-root | test-scope-helper-at-root | validate/report --config archkeel-tests.toml run | TESTS-ASSIGNMENT-COMPLETE, TESTS-HELPERS-IN-SUPPORT, TESTS-ROOT-LAYOUT | graph.drift, rule.violated, rule.violated, rule.violated | tests/integration/test_place_order.py, tests/orders.py, tests/support/orders.py, tests/unit/test_entities.py |
