...
| validation | module.placement | validation-module-placement | validate/report run | COMP-MODEL | rule.violated | architecture-contract.json, shop/model_rules.py |
