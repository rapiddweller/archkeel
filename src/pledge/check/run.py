...
from pledge.host.records import parse_records
from pledge.ir.codec import canonical_report_bytes, declaration_paths, decode_json, parse_lock
from pledge.ir.digest import package_digest
from pledge.ir.lock import LOCK_PATH, LockError, verify_observation
from pledge.ir.measurements import Measurements
from pledge.ir.model import CheckProvenance, Diagnostic, DiagnosticError, Observation, RunResult
from pledge.ir.trace import trace_valid_violations, validate_evidence_classes
...
def run_check(
    ...
    *,
    ...
    with TemporaryDirectory(prefix="pledge-declarations-") as temporary:
